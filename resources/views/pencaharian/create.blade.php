...
@section('container')
    {{-- @section('contents') --}}
    <div class="py-12">
        <h1>Halaman tambah data pencaharian</h1>
    </div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                {{-- from tambah data --}}
                <div class="col-lg-8">
                    <form method="post" action="{{ route('pencaharian.store') }}" class="mt-6 space-y-6"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="jns_mpp">Jenis Pencaharian</label>
                            <select id="jns_mpp" class="form-control @error('jns_mpp') is-invalid @enderror"
                                name="jns_mpp">
                                <option selected>Pilih Jenis Pencaharian</option>
