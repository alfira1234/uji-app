...
@section('container')
    {{-- @section('contents') --}}
    <div class="py-12">
        <h1>Halaman tambah data pendidikan</h1>
    </div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                {{-- from tambah data --}}
                <div class="col-lg-8">
                    <form method="post" action="{{ route('pendidikan.store') }}" class="mt-6 space-y-6"
                        ...
                        <select class="form-select" name="jenis" aria-label="Default select example">
                            ...
                            <option value="Sekolah Di Usia">Sekolah Di Usia</option>
                            <option value="Putus Sekolah Usia">Putus Sekolah Usia</option>
                        </select>
