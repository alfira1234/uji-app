...
@section('navbar')
    ...
    <div class="row">
        ...
        <!-- Begin Page Content -->
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tabel daftar usia</h1>
    </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('usia.edit', $item->id) }}" class="btn btn-warning btn-sm"><span><i
                                                class="fa-solid fa-pen-to-square"></i></span></a>

                                    <form action="{{ route('usia.delete', $item->id) }}" method="post" class="d-inline">
                                        @method('delete')
                                        @csrf
