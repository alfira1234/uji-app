...
@section('container')
    ...
    <div class="row">
        ...
        <!-- Begin Page Content -->
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tabel daftar penduduk</h1>
    </div>
        ...
        <div class="card-body">
            <div style="overflow-x:auto;">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('penduduk.edit', $item->id) }}"
                                        class="btn btn-warning btn-sm"><span><i class="bi bi-pencil-square"></i></span></a>

                                    <form action="{{ route('penduduk.delete', $item->id) }}" method="post"
                                        class="d-inline">
                                        @method('delete')
                                        @csrf
                ...
                <div class="form-group d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="/pendidikan" class="btn btn-primary">Lanjut</a>
                </div>
