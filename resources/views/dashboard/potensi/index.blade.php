...
@section('container')
    <div class="row">
        ...
        <!-- Begin Page Content -->
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tabel daftar Potensi</h1>
    </div>
        ...
        <div class="card-body">
            <div style="overflow-x:auto;">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-sm front-medium text-gray-900 px-20 py-15 text-center">Potensi</th>
                            <th class="text-sm front-medium text-gray-900 px-20 py-15 text-center">Pengembangan</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('potensi.edit', $item->id) }}" class="btn btn-warning btn-sm"><span><i
                ...
                <div class="form-group d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="/dashboard/umkm" class="btn btn-warning">Kembali</a>
