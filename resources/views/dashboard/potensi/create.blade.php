...
@section('container')
    {{-- @section('contents') --}}
    <div class="py-12">
        <h1>Halaman tambah data Potensi</h1>
    </div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                {{-- from tambah data --}}
                <div class="col-lg-8">
                    <form method="post" action="{{ route('potensi.store') }}" class="mt-6 space-y-6"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-group">
                                <input name="potensi" type="text"
                                    ...
                                    placeholder="Nama Potensi" required autofocus>
                                @error('potensi')
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <div class="form-group">
                                <input name="pengembangan" type="text"
                                    ...
                                    placeholder="Keterangan Pengembangan" required autofocus>
                                @error('pengembangan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="mb-3">
                            <label for="pengembangan" class="form-label">Pengembangan</label>
                            {{-- <input id="pengembangan" type="hidden" name="pengembangan"> --}}
                            <textarea class="form-control" input="pengembangan" id="pengembangan" name="pengembangan" rows="3"></textarea>
                        </div>
