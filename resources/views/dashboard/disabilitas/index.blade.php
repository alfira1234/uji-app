...
@section('container')
    ...
    <div class="row">
        ...
        <!-- Begin Page Content -->
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tabel daftar disabilitas</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="{{ route('disabilitas.create') }}">
        ...
        <div class="card-body">
            <div style="overflow-x:auto;">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-sm front-medium text-gray-900 px-20 py-15 text-center">Jenis disabilitas</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('disabilitas.destroy', $item->id) }}" method="post"
                                        class="d-inline">
                                        @method('delete')
                                        @csrf
                ...
                <div class="form-group d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <a href="/dashboard/umkm" class="btn btn-primary">Lanjut</a>
                </div>
            </div>
        </div>
    </div>
