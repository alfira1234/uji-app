...
@section('container')
    <div class="row">
        ...
        <!-- Begin Page Content -->
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Tabel daftar Wargakenegaraan</h1>
    </div>
        ...
        <div class="card-body">
            <div style="overflow-x:auto;">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-sm front-medium text-gray-900 px-20 py-15 text-center">Warga</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('warga.edit', $item->id) }}" class="btn btn-warning btn-sm"><span><i
                ...
                <div class="form-group d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="/agama" class="btn btn-warning">Kembali</a>
                    <a href="/dashboard/kesehatan" class="btn btn-primary">Lanjut</a>
                </div>
            </div>
        </div>
    </div>
