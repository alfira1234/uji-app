...
@section('container')
    {{-- @section('contents') --}}
    <div class="py-12">
        <h1>Halaman edit data Warga Kenegaraan</h1>
    </div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                {{-- from tambah data --}}
                <div class="col-lg-8">
                    <form method="post" action="{{ route('warga.update', $warga->id) }}" class="mt-6 space-y-6"
                        ...
                        <select class="form-select" name="warga" aria-label="Default select example">
                            ...
                            <option @if ($warga['warga'] == 'WNI') selected @endif value="WNI">WNI</option>
                            <option @if ($warga['warga'] == 'WNA') selected @endif value="WNA">WNA</option>
                        </select>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-group">
                                <input name="laki" type="text"
                                    ...
                                    value="{{ $warga->laki }}" placeholder="Masukkan Jumlah" required autofocus>
                                {{-- @error('laki')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-group">
                                <input name="perempuan" type="text"
                                    ...
                                    value="{{ $warga->perempuan }}" placeholder="Masukkan Jumlah" required autofocus>
                                {{-- @error('perempuan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
